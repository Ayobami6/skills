...
| :--- | :--- | :--- | :--- |
| **`bitnob-integration`** | Complete guide and integration assistant for the Bitnob API (bitnob.dev / api.bitnob.co): Bitcoin Lightning Network micropayments, on-chain BTC transactions, USD virtual card issuance & management, customer KYC, African fiat payouts (bank & mobile money in NGN, GHS, KES), currency swaps, and HMAC-SHA512 webhook security. | `npx skills add Ayobami6/skills --skill bitnob-integration` | [`skills/bitnob-integration/SKILL.md`](./skills/bitnob-integration/SKILL.md) |
...
| **`mailnow-integration`** | Comprehensive guide and assistant for the MailNow Email API & SDKs (mailnow.xyz): sending transactional/bulk emails, tracking delivery statuses, managing email templates, using Python (`py-mailnow`) & Go (`go-mailnow`) SDKs, and configuring FastMCP servers for AI agents. | `npx skills add Ayobami6/skills --skill mailnow-integration` | [`skills/mailnow-integration/SKILL.md`](./skills/mailnow-integration/SKILL.md) |
| **`paystack-integration`** | Complete guide and implementation assistant for the Paystack Payments API: transaction initialization, server-side verification, Paystack Inline JS, HMAC-SHA512 webhook security, recurring debits, bank transfers/payouts, and Dedicated Virtual Accounts. | `npx skills add Ayobami6/skills --skill paystack-integration` | [`skills/paystack-integration/SKILL.md`](./skills/paystack-integration/SKILL.md) |
